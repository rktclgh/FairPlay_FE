                ...
                <nav className="text-left">
                    ...
                    <div className="mb-4 space-y-0">
                        ...
                        <div className="space-y-1">
                            ...
                            <Link
                                to="/host/advertisement-dashboard"
                                className={`block cursor-pointer text-[15px] tracking-[0] whitespace-nowrap no-underline ${location.pathname === "/host/advertisement-dashboard"
                                    ? "[font-family:'Roboto-Bold',Helvetica] font-bold text-black"
                                    : "[font-family:'Roboto-Medium',Helvetica] font-medium text-[#00000080]"
                                    }`}
                                style={{
                                    textDecoration: 'none',
                                    color: location.pathname === "/host/advertisement-dashboard" ? "black" : "#00000080"
                                }}
                                onMouseEnter={(e) => {
                                    e.currentTarget.style.color = location.pathname === "/host/advertisement-dashboard" ? "black" : "#00000080";
                                }}
                                onMouseLeave={(e) => {
                                    e.currentTarget.style.color = location.pathname === "/host/advertisement-dashboard" ? "black" : "#00000080";
                                }}
