    ...
    return (
        <div className="bg-white flex flex-row justify-center w-full">
            <div className="bg-white w-[1256px] h-[1442px] relative">
                ...
                <div className="absolute w-[400px] h-[52px] top-[545px] left-[428px] border-b [border-bottom-style:solid] border-gray-300 relative">
                    <input
                ...
                {/* 회원가입 완료 버튼 */}
                <button
                    className={`absolute w-[400px] h-12 top-[849px] left-[428px] rounded-lg flex items-center justify-center transition-colors focus:outline-none ${isSignUpEnabled
                ...
                <div className="absolute w-[58px] h-[22px] top-[924px] left-[599px]">
                ...
                {/* 카카오 회원가입 버튼 */}
                <button className="absolute w-[400px] h-12 top-[970px] left-[428px] bg-[#fee500] rounded-lg flex items-center justify-center cursor-pointer hover:bg-yellow-400 transition-colors focus:outline-none focus:ring-1 focus:ring-gray-300" style={{ borderRadius: '8px' }}>
