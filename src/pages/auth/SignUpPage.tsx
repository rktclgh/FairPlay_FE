    ...
    return (
        <div className="bg-white flex flex-row justify-center w-full">
            <div className="bg-white w-[1256px] h-[1442px] relative">
                ...
                <div className="absolute w-[400px] h-[52px] top-[650px] left-[428px] border-b border-gray-300">
                    <input
                ...
                <div className="absolute w-[400px] h-[52px] top-[769px] left-[428px] border-b border-gray-300">
                    <input
                ...
                <div className="absolute w-[400px] h-[52px] top-[884px] left-[428px] border-b border-gray-300">
                    <input
                        type="tel"
                        value={phone}
                ...
                {/* 카카오 회원가입 버튼 */}
                <button
                    className="absolute w-[400px] h-12 top-[1085px] left-[428px] bg-[#fee500] rounded-lg flex items-center justify-center cursor-pointer hover:bg-yellow-400 transition-colors focus:outline-none focus:ring-1 focus:ring-gray-300"
                    style={{ borderRadius: '8px' }}
                ...
                <div className="absolute w-[1256px] h-[205px] top-[1237px] left-0 bg-white border-t border-[#0000001f]">
