    ...
    return (
        <div className="bg-white flex flex-row justify-center w-full">
            <div className="bg-white w-[1256px] h-[1442px] relative">
                ...
                {/* 비밀번호 입력 */}
                <div className={`absolute left-[428px] [font-family:'Segoe_UI-Semibold',Helvetica] font-normal text-black text-sm leading-[21px] tracking-[0] whitespace-nowrap ${emailChecked ? 'top-[620px]' : 'top-[515px]'}`}>
                    비밀번호
                </div>
                <div className={`absolute w-[400px] h-[52px] left-[428px] border-b border-gray-300 ${emailChecked ? 'top-[650px]' : 'top-[545px]'}`}>
                    <input
                ...
                <p className={`absolute left-[428px] [font-family:'Segoe_UI-Regular',Helvetica] font-normal text-gray-500 text-xs leading-[18px] tracking-[0] whitespace-nowrap ${emailChecked ? 'top-[709px]' : 'top-[594px]'}`}>
                    • 8자 이상 16자 이하
                </p>

                {/* 비밀번호 확인 */}
                <div className={`absolute left-[428px] [font-family:'Segoe_UI-Semibold',Helvetica] font-normal text-black text-sm leading-[21px] tracking-[0] whitespace-nowrap ${emailChecked ? 'top-[739px]' : 'top-[624px]'}`}>
                    비밀번호 확인
                </div>
                <div className={`absolute w-[400px] h-[52px] left-[428px] border-b border-gray-300 ${emailChecked ? 'top-[769px]' : 'top-[654px]'}`}>
                    <input
                ...
                {/* 비밀번호 일치 상태 표시 */}
                {passwordMatch !== null && (
                    <div className={`absolute left-[428px] flex items-center gap-2 ${emailChecked ? 'top-[821px]' : 'top-[706px]'} ${passwordMatch ? 'text-green-600' : 'text-red-500'
                        }`}>
                        {passwordMatch ? (
                            <>
                                <FaCheck size={14} />
                ...
                {/* 휴대폰 번호 입력 */}
                <div className={`absolute left-[428px] [font-family:'Segoe_UI-Semibold',Helvetica] font-normal text-black text-sm leading-[21px] tracking-[0] whitespace-nowrap ${emailChecked ? 'top-[854px]' : 'top-[739px]'}`}>
                    휴대폰 번호
                </div>
                <div className={`absolute w-[400px] h-[52px] left-[428px] border-b border-gray-300 ${emailChecked ? 'top-[884px]' : 'top-[769px]'}`}>
                    <input
                        type="tel"
                        value={phone}
                ...
                <button
                    ...
                    className={`absolute w-[400px] h-12 left-[428px] rounded-lg flex items-center justify-center transition-colors focus:outline-none ${emailChecked ? 'top-[964px]' : 'top-[849px]'} ${isSignUpEnabled
                ...
                <div className={`absolute w-[58px] h-[22px] left-[599px] ${emailChecked ? 'top-[1039px]' : 'top-[924px]'}`}>
                ...
                {/* 카카오 회원가입 버튼 */}
                <button
                    className={`absolute w-[400px] h-12 left-[428px] bg-[#fee500] rounded-lg flex items-center justify-center cursor-pointer hover:bg-yellow-400 transition-colors focus:outline-none focus:ring-1 focus:ring-gray-300 ${emailChecked ? 'top-[1085px]' : 'top-[970px]'}`}
                    style={{ borderRadius: '8px' }}
                ...
                <div className={`absolute w-[1256px] h-[205px] left-0 bg-white border-t border-[#0000001f] ${emailChecked ? 'top-[1237px]' : 'top-[1122px]'}`}>
