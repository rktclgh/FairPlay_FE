...
export const ReservationStatistics: React.FC = () => {
    ...
    const [categoryData] = useState([
        { name: '박람회', value: 35, color: '#8884d8' },
        { name: '강연/세미나', value: 25, color: '#82ca9d' },
        { name: '전시/행사', value: 20, color: '#ffc658' },
        { name: '공연', value: 15, color: '#ff7300' },
        { name: '축제', value: 5, color: '#8dd1e1' }
    ]);
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{formatCurrency(statsData.totalReservations)}건</p>
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{formatCurrency(statsData.cancelledReservations)}건</p>
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">₩{formatCurrency(statsData.averageAmount)}</p>
                                    <div className={`text-sm font-medium ${getChangeColor(statsData.monthOverMonth)} flex items-center gap-1 mt-1`}>
                                        <span>{getChangeIcon(statsData.monthOverMonth)}</span>
                                        <span>{Math.abs(statsData.monthOverMonth)}%</span>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <p className="text-sm text-gray-600 mb-4">
                                파란색 선: 예약 건수, 초록색 선: 예약 금액을 나타냅니다
                            </p>
                            <ResponsiveContainer width="100%" height={300}>
                                <LineChart data={trendData[selectedPeriod as keyof typeof trendData]}>
