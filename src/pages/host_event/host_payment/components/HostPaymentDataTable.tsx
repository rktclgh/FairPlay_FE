...
import { PaymentAdminDto, HostPaymentSearchCriteria, PaginationInfo } from '../types/payment.types';

interface HostPaymentDataTableProps {
...
const HostPaymentDataTable: React.FC<HostPaymentDataTableProps> = ({
  payments,
  pagination,
  loading,
  onPageChange,
...
export default HostPaymentDataTable;