// 결제 검색 조건 (행사 담당자용 - eventName 검색 제외)
export interface HostPaymentSearchCriteria {
...
// 정렬 필드 (eventName 제외)
export type PaymentSortField = 'paymentId' | 'paidAt' | 'amount' | 'buyerName' | 'paymentStatus';
...
// 결제 관리 훅 상태 (행사 담당자용)
export interface HostPaymentManagementState {
