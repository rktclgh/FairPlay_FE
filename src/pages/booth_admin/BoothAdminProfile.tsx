...
export const BoothAdminProfile = () => {
        ...
        <div className="bg-white flex flex-row justify-center w-full">
            <div className="bg-white w-[1256px] min-h-screen relative">
                ...
                <div className={`absolute w-[949px] h-[335px] left-64 ${showPasswordChange ? 'top-[600px]' : 'top-[455px]'}`}>
                    ...
                    {/* 권한 정보 추가 */}
                    <div className="absolute top-[295px] left-0 [font-family:'Roboto-Medium',Helvetica] font-medium text-[#00000080] text-[15px] leading-[54px] tracking-[0] whitespace-nowrap">
                        권한
                    </div>
                    ...
                    <p className="absolute top-[323px] left-0 [font-family:'Roboto-Regular',Helvetica] font-normal text-black text-base leading-[54px] tracking-[0] whitespace-nowrap">
                        {userInfo.role === 'BOOTH_MANAGER' ? '부스 관리자' : userInfo.role}
                    </p>

                    <div className="w-[947px] h-[79px] top-[302px] border-b [border-bottom-style:solid] border-[#0000001a] absolute left-0" />

                    {/* 개인정보 수정 버튼 - 권한 정보 아래 오른쪽 정렬 */}
                    <div className="absolute top-[390px] right-0">
                        <button
