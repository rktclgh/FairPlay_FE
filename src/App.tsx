...
import { ParticipatingBooths } from "./pages/user_event/ParticipatingBooths";
import BoothList from "./pages/user_booth/BoothList";
import BoothDetail from "./pages/user_booth/BoothDetail";
import BoothApplication from "./pages/user_booth/BoothApplication";
            ...
            <main className={`flex-1 ${bottomPadding}`}>
                <Suspense fallback={<div />}>
                    <Routes>
                        ...
                        <Route path="/host/events/:eventId/booth-types" element={<HostRouteGuard><BoothTypeManagement /></HostRouteGuard>} />
                        <Route path="/host/events/:eventId/booths" element={<HostRouteGuard><BoothParticipants /></HostRouteGuard>} />
